...
import {ERC165Checker} from "chainlink-ccip/contracts/src/v0.8/vendor/ERC165Checker.sol";
...
contract ImmutableExample_sanity is EVM2EVMOnRampSetup {
    function testExamples() public {
        ImmutableExample e = new ImmutableExample(
            s_sourceRouter,
        ...
        assertEq(
            IERC20(s_sourceFeeToken).allowance(
                address(e),
        ...
        assertEq(
            address(s_onRamp.getPoolBySourceToken(IERC20(s_sourceTokens[1]))),
        ...
        assertEq(
            IERC20(s_sourceTokens[1]).balanceOf(address(s_sourceRouter)),
            0
        );
