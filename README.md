...
Or, if you want to pay for Chainlink CCIP Fees in Native coins, you can fill the [`BasicTokenSender.sol`](./contracts/BasicTokenSender.sol) smart contract with 0.1 Avalanche Fuji AVAX by running:
