...
contract Legacy02 is Script {
    function run(
        ...
        console2.log("[INFO] Legacy02: ExtraArgsV2 token transfer (EOA sender)");
        ...
        console2.log("[INFO] Allow out-of-order execution:", allowOutOfOrderExecution);
        ...
        bytes memory extraArgs = extraArgsEncoder.encodeV2(gasLimit, allowOutOfOrderExecution);
